...
func CreateTopTables() {
    ...
    tran("manage", func(tx *sql.Tx) error {
        tx.Exec("create table setting( " +
        ...
        tx.Exec("create table setting( " +
                ...
                " value text " +
                ");", []interface{}{})
        tx.Exec("insert into setting(name, value)" +
                "values ('project_name', ?);", []interface{}{"main project"})
        tx.Exec("insert into setting(name, value)" +
                "values ('home_description', ?);", []interface{}{"home"})
        tx.Exec("insert into setting(name, value)" +
                "values ('home_url', '');", []interface{}{})
        tx.Exec("insert into setting(name, value)" +
                "values ('locale', ?);", []interface{}{"en_US"})
        tx.Exec("create table project_info ( " +
                " id integer not null primary key, " +
                " name text, " +
                " deleted integer default 0, " +
                " sort integer " +
                ");", []interface{}{})
        tx.Exec("insert into project_info(id, name, deleted, sort) " +
                "values (1, 'top', 0, 1);", []interface{}{})
        tx.Exec("insert into project_info(id, name, deleted, sort) " +
                "values (2, 'Sand Box', 0, 1);", []interface{}{})
        tx.Exec("create table wiki( " +
                " id integer not null primary key, " +
                " name text, " +
                " content text, " +
                " registerdate text " +
                ");", []interface{}{})
        tx.Exec("insert into wiki(id, name, content, registerdate) " +
                "values (NULL, 'top', ?, current_timestamp);", []interface{}{"[wiki syntax example]"})
        return nil
    })
}

func CreateProjectTables(projectName string) {
    logger.Debug("CreateProjectTables")

    tran(projectName, func(tx *sql.Tx) error {
        tx.Exec("create table setting( " +
                " name text primary key, " +
                " value text " +
                ");", []interface{}{})
        ...
        tx.Exec("insert into setting(name, value)" +
                "values ('home_url', '');", []interface{}{})
        tx.Exec("insert into setting(name, value)" +
                "values ('upload_max_size', 512);", []interface{}{})
        tx.Exec("create table setting_file( " +
                " name text primary key, " +
                " file_name text, " +
                " size integer, " +
                " mime_type text, " +
...
//                "E06F371676E90000000049454E44AE426082')", []interface{}{})
//        tx.Exec(
...
//                ");", []interface{}{})
//        tx.Exec(
//                "create index index_element_type_0 on element_type (id, type, display_in_list, sort)", []interface{}{})
//        tx.Exec(
...
//                ");", []interface{}{})
//        tx.Exec(
//                "create index index_list_item_0 on list_item (id, sort)", []interface{}{})
//        tx.Exec(db, "insert into list_item(id, element_type_id, name, close, sort) values (1, 3, ?, 0, 1);",
//                COLUMN_TYPE_TEXT, _("new"),
//                []interface{}{})
//        tx.Exec(db, "insert into list_item(id, element_type_id, name, close, sort) values (2, 3, ?, 0, 2);",
//                COLUMN_TYPE_TEXT, _("accepted"),
//                []interface{}{})
//        tx.Exec(db, "insert into list_item(id, element_type_id, name, close, sort) values (3, 3, ?, 0, 3);",
//                COLUMN_TYPE_TEXT, _("fixed"),
//                []interface{}{})
//        tx.Exec(db, "insert into list_item(id, element_type_id, name, close, sort) values (4, 3, ?, 0, 4);",
//                COLUMN_TYPE_TEXT, _("reservation"),
//                []interface{}{})
//        tx.Exec(db, "insert into list_item(id, element_type_id, name, close, sort) values (5, 3, ?, 1, 5);",
//                COLUMN_TYPE_TEXT, _("complete"),
//                []interface{}{})
//        tx.Exec(db, "insert into list_item(id, element_type_id, name, close, sort) values (6, 3, ?, 1, 6);",
//                COLUMN_TYPE_TEXT, _("wontfix"),
//                []interface{}{})
//        tx.Exec(db, "insert into list_item(id, element_type_id, name, close, sort) values (7, 3, ?, 1, 7);",
//                COLUMN_TYPE_TEXT, _("specification"),
//                []interface{}{})
//        tx.Exec(db, "insert into list_item(id, element_type_id, name, close, sort) values (8, 3, ?, 1, 8);",
//                COLUMN_TYPE_TEXT, _("deleted"),
//                []interface{}{})
//        tx.Exec(db, "insert into list_item(id, element_type_id, name, close, sort) values (9, 4, ?, 0, 1);",
//                COLUMN_TYPE_TEXT, _("page"),
//                []interface{}{})
//        tx.Exec(db, "insert into list_item(id, element_type_id, name, close, sort) values (10, 4, ?, 0, 2);",
//                COLUMN_TYPE_TEXT, _("batch process"),
//                []interface{}{})
//        tx.Exec(db, "insert into list_item(id, element_type_id, name, close, sort) values (11, 4, ?, 0, 3);",
//                COLUMN_TYPE_TEXT, _("document"),
//                []interface{}{})
//        tx.Exec(db, "insert into list_item(id, element_type_id, name, close, sort) values (12, 5, ?, 0, 1);",
//                COLUMN_TYPE_TEXT, _("emergency"),
//                []interface{}{})
//        tx.Exec(db, "insert into list_item(id, element_type_id, name, close, sort) values (13, 5, ?, 0, 2);",
//                COLUMN_TYPE_TEXT, _("high"),
//                []interface{}{})
//        tx.Exec(db, "insert into list_item(id, element_type_id, name, close, sort) values (14, 5, ?, 0, 3);",
//                COLUMN_TYPE_TEXT, _("middle"),
//                []interface{}{})
//        tx.Exec(db, "insert into list_item(id, element_type_id, name, close, sort) values (15, 5, ?, 0, 4);",
...
//                ");", []interface{}{})
//        tx.Exec(
//                "create index index_ticket_0 on ticket (id, last_message_id, last_message_id, closed)", []interface{}{})
//        tx.Exec(
